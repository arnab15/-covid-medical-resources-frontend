...
function ResourceRequirementCard({ resourceRequirements }) {
   const {
      urgentRequirement,
      resourceName,
      typesOfResource,
   ...
   let ugRequirement = urgentRequirement === "Yes" ? urgentRequirement : "";
      ...
      <div>
         <div className="relative bg-white py-6 px-6 rounded-3xl w-full   md:w-96 shadow-xl my-10">
            <div className=" text-white flex items-center absolute rounded-full py-4 bg-gray-200 px-4 shadow-xl  left-4 -top-6">
               <img className="h-10 w-10" src={alarm} alt="medical supplies" />
            </div>
            <div className="relative">
               {ugRequirement ? (
                  <span className="px-4 py-1  text-base rounded-full text-red-600  bg-red-200 inline-block ml-20 ">
                     urgent requirement
                  </span>
               ) : (
                  <span className="px-4 py-1  text-base rounded-full text-green-600  bg-green-200  absolute inline-block ml-16 ">
                     requirement
                  </span>
               )}
            </div>
